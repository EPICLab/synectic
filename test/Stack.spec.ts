...
describe('Stack class', () => {
  ...
  it('Should have the same parent as the first parameter Card', () => {
    let card1 = new Card(global.Synectic.current);
    let card2 = new Card(global.Synectic.current);
  ...
  it('Should remove child from parent when add is invoked', () => {
    const card1 = new Card(global.Synectic.current);
    const card2 = new Card(global.Synectic.current);
