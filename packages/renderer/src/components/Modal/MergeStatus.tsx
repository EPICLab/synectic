...
import {Alert, type AlertColor, Paper} from '@mui/material';
import type {MergeOutput} from '@syn-types/app';
import {LinearProgressWithLabel} from '../Status';

const StatusBar = ({severity, message}: {severity: AlertColor; message: string | undefined}) => {
  return (
    <Paper>
      <Alert
        sx={{backgroundColor: 'rgba(56, 54, 57, 0.95)'}}
        severity={severity}
      >
        {message}
      </Alert>
