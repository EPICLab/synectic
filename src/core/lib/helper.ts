 ...
 * @param className CSS class name to be added to target; there is no effect if CSS class is already present in the CSS class list of target.
 */
 ...
 * @param className CSS class to be removed from target; there is no effect if CSS class is not present in the CSS class list of target.
 */
 ...
 * @param visiblity Optional setting for explicitly setting show/hide state; true shows the element, false hides the element.
 */
