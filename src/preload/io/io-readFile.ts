...
// TODO: Temporary solution to avoid `prettier-plugin-jsdoc` bug: https://github.com/hosseinmd/prettier-plugin-jsdoc/issues/205
 ...
 *   flags (default: `"r"`). The possible option values are: 2@^5!~#sdE!_TABLE
