 ...
 * elements. Luckily, TypeScript 4.1 includes recursive conditional types ( [TS4.1 Recursive
 * Conditional
 * Types](https://devblogs.microsoft.com/typescript/announcing-typescript-4-1/#recursive-conditional-types)),
