...
describe('thunks/metafiles', () => {
  ...
  //     store.dispatch(metafileAdded(mockedMetafile));
  //     const metafile = await store
  //       .dispatch(fetchMetafile({ path: mockedMetafile.path, handlers: [mockedMetafile.handler] }))
  //       .unwrap();
  //     expect(metafile).toStrictEqual(mockedMetafile);
  //   });
  ...
  //     store.dispatch(metafileAdded(mockedMetafile));
  //     const metafile = await store
  //       .dispatch(fetchMetafile({ path: mockedMetafile.path, handlers: ['Browser'] }))
  //       .unwrap();
  //     expect(metafile).not.toStrictEqual(mockedMetafile);
  //   });
  ...
  //     expect(isUUID(metafile.id.toString())).toBe(true);
  //     expect(metafile).toStrictEqual(
  //       expect.objectContaining({
  //         ...template
  //       })
  ...
  //     jest.spyOn(gitStatus, 'worktreeStatus').mockResolvedValueOnce({
  //       // mock for git-status of current branch
  //       ref: 'test',
  //       root: 'foo/',
  //       status: 'clean',
  //       bare: false,
  ...
  //     const updated = await store.dispatch(updateVersionedMetafile(metafile.id)).unwrap();
  //     expect(updated).toStrictEqual(
  //       expect.objectContaining({
  //         repo: 'c5739e69-9979-41fe-8605-5bb5ff341027',
  //         branch: '9ae32e4a-10f2-4f7b-93d6-39ccb466c504',
