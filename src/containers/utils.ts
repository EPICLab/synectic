 ...
 * @returns {Array.<[object[], object[], object[]]>} The resulting array of arrays where
 * symmetrically different elements from `array1` are in the left subarray, intersection subarray
 * containing pairs of element `e1` from `array1` and the complementary element `e2` from `array2`
 * in the center subarray, and the symmetrically different elements from `array2` are in the right
 * subarray.
 */
