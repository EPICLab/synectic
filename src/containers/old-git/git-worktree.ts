...
import * as gitWorktree from '../git/git-worktree'; // eslint-disable-line @typescript-eslint/no-unused-vars
 ...
 * @returns {Promise<Worktree>} A Worktree object.
 */
 ...
 * @returns {Promise<[string, 0 | 1, 0 | 1 | 2, 0 | 1 | 2 | 3][] | undefined>} A Promise object containing an array of entries comprised of filenames and HEAD/WORKDIR/STAGE status digits, or undefined
 ...
 * @returns {Promise<GitStatus | undefined>} A Promise object containing undefined if the path is not contained within a git repository, or a status indicator
...
/**
 * @deprecated This implementation uses old-git functions that rely on isomorphic-git, please use {@link gitWorktree.worktreeAdd} instead.
 * 
 ...
 * @returns {Promise<void>} A Promise object for the add worktree operation.
 */
...
/**
 * @deprecated This implementation uses old-git functions that rely on isomorphic-git, please use {@link gitWorktree.worktreeList} instead.
 * 
 ...
 * @returns {Promise<Worktree[] | undefined>} A Promise containing an array of worktree details, or undefined if not under version control.
 */
...
/**
 * @deprecated This implementation uses old-git functions that rely on isomorphic-git, please use {@link gitWorktree.worktreeLock} instead.
 * @param worktree A Worktree object.
...
/**
 * @deprecated This implementation uses old-git functions that rely on isomorphic-git, please use {@link gitWorktree.worktreeMove} instead.
 * @param worktree A Worktree object.
 * @param newPath Path to move the worktree into.
 * @returns {void}
 */
...
/**
 * @deprecated This implementation uses old-git functions that rely on isomorphic-git, please use {@link gitWorktree.worktreePrune} instead.
 ...
 * @returns {Promise<void>} A Promise for the prune worktree command.
 */
...
/**
 * @deprecated This implementation uses old-git functions that rely on isomorphic-git, please use {@link gitWorktree.worktreeRemove} instead.
 ...
 * @returns {Promise<void>} A Promise for the removing worktree command.
 */
