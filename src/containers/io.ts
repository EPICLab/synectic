 ...
 * @returns {Promise<fs.PathLike[]>} A Promise object for an array containing filepaths for either all child directories or all
 * child files.
 */
export const filterReadArray = async (
  ...
  return await filepaths.reduce(
    async (previousPromise: Promise<fs.PathLike[]>, filepath: fs.PathLike) => {
